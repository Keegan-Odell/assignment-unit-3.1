...
let favoriteFoods = ['steak', 'cheeseburger', 'cottage cheese', 'spinach'];
...
favoriteFoods.unshift('peanut butter');
...
favoriteFoods.splice(2, 1, 'yogurt');
console.log(favoriteFoods);
...
let crazyArray = favoriteFoods.concat(animalArray);
